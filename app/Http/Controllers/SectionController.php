...
class SectionController extends Controller
{
    ...
    public function index(User $provider)
    {
        if (request()->expectsJson()) {
            ...
            return Datatables::of($sections)
                ...
                ->editColumn('actions', function ($row) {
                    return "<a href='javascript:;' data-id='{$row->id}' class='btn btn-sm btn-clean btn-icon btn-icon-md showEditSectionModal' title='تعديل'>
        ...
        return view('sections.index', compact('provider'));
    }
    ...
    public function store(Request $request, User $provider)
    {
        ...
        $section = new Section;
        $section->provider_id = $provider->id;
    ...
    {
        return view('sections.show.section-info', compact('section'))->render();
    }
