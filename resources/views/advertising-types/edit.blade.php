...
@section('title', 'تعديل بيانات نوع دعاية')
...
<div class="subheader py-2 py-lg-6  subheader-solid " id="kt_subheader">
   <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
      ...
      <div class="d-flex align-items-center flex-wrap mr-1">
         ...
         <div class="d-flex align-items-baseline flex-wrap mr-5">
            ...
            <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
               ...
               <li class="breadcrumb-item">
                  <a href="{{ route('advertising-types.index') }}" class="text-muted">
                    أنواع الدعاية
                  </a>
               </li>
               <li class="breadcrumb-item">
      ...
      <div class="d-flex align-items-center">
        ...
        <a href="{{ route('advertising-types.index') }}" class="btn btn-light-dark font-weight-bold btn-sm px-4 font-size-base ml-2">عودة</a>
      </div>
      <!--end::Toolbar-->
   </div>
</div>
...
<div class="card card-custom">
    ...
    <div class="card-body px-0">
        <form class="form" id="kt_form" action="{{ route('advertising-types.update', $advertisingType) }}" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-7 my-2">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid @error('name') is-invalid @enderror" type="text" name="name" value="{{ old('name', $advertisingType->name) }}" placeholder="نوع الدعاية"/>
                                    @error('name')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-3">
                                    <span class="switch switch-icon">
                                        <label>
                                            <input type="checkbox" @if($advertisingType->status) checked="checked" @endif name="status"/>
                                            <span></span>
                                        </label>
                                    </span>
                                </div>
