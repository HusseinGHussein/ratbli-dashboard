         ...
         <div class="d-flex align-items-baseline flex-wrap mr-5">
            ...
            <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
               <li class="breadcrumb-item">
                  <a href="{{ url('/provider') }}" class="text-muted">
                    الرئيسية
                  </a>
               </li>
               <li class="breadcrumb-item">
    ...
    <script type="text/javascript">
      $(document).ready( function () {
       $('#dataTable').DataTable({
          ...
          serverSide: true,
          ajax: {
            url: "{{ route('provider.sections.index') }}",
            type: "GET",
            data: function (query) {
              //
            }
        ...
        $('#kt_save').click(function(e) {
            ...
            $.ajax({
                url: "{{ route('provider.sections.store') }}",
                method: 'post',
                data: {
                    name: $('#name').val(),
                    status: $('#status').val()
        ...
        $('body').on('click', '.showEditSectionModal', function () {
          ...
          $.get("/provider/sections"+'/'+section, function (data) {
        ...
        $('#kt_update').click(function(e) {
            ...
            $.ajax({
                url: "/provider/sections/"+$('#sectionId').val(),
                method: 'PUT',
                data: {
                    name: $('#nameEdit').val(),
