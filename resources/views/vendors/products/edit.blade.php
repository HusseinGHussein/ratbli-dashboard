...
<div class="card card-custom">
    ...
    <div class="card-body px-0">
        <form class="form" id="kt_form" action="{{ route('provider.products.update', $product) }}" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
                        ...
                        <div class="col-xl-7 my-2">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-3">
                                    <span class="switch switch-icon">
                                        <label>
                                            <input type="checkbox" @if(old('status', $product->status)) checked @endif name="status"/>
                                            <span></span>
                                        </label>
                                    </span>
                                </div>
...
<script>
    ...
    $('body').on('click', '.deleteProductImage', function () {
        ...
        swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: '/provider/delete-product-image/'+productImage,
                    method: 'POST',
                    headers: {
