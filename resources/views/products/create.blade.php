...
<div class="subheader py-2 py-lg-6  subheader-solid " id="kt_subheader">
   <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
      ...
      <div class="d-flex align-items-center flex-wrap mr-1">
         ...
         <div class="d-flex align-items-baseline flex-wrap mr-5">
            ...
            <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
               ...
               <li class="breadcrumb-item">
                  <a href="{{ route('providers.show', $provider) }}" class="text-muted">
                    المنتجات
                  </a>
               </li>
               <li class="breadcrumb-item">
      ...
      <div class="d-flex align-items-center">
        ...
        <a href="{{ route('providers.show', $provider) }}" class="btn btn-light-dark font-weight-bold btn-sm px-4 font-size-base ml-2">عودة</a>
      </div>
      <!--end::Toolbar-->
   </div>
</div>
...
<div class="card card-custom">
    ...
    <div class="card-body px-0">
        <form class="form" id="kt_form" action="{{ route('providers.products.store', $provider) }}" method="POST" enctype="multipart/form-data">
            @csrf
