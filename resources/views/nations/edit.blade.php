...
<div class="card card-custom">
    ...
    <div class="card-body px-0">
        <form class="form" id="kt_form" action="{{ route('nations.update', $nation) }}" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-7 my-2">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid @error('name') is-invalid @enderror" type="text" name="name" value="{{ old('name', $nation->name) }}" placeholder="الاسم (العربية)"/>
                                    @error('name')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid @error('name_en') is-invalid @enderror" type="text" name="name_en" value="{{ old('name_en', $nation->name_en) }}" placeholder="الاسم (الانجليزية)"/>
                                    @error('name_en')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid @error('code') is-invalid @enderror" type="text" name="code" value="{{ old('code', $nation->code) }}" placeholder="كود الدولة"/>
                                    @error('code')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid @error('currency_name') is-invalid @enderror" type="text" name="currency_name" value="{{ old('currency_name', $nation->currency_name) }}" placeholder="العملة (العربية)"/>
                                    @error('currency_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid @error('currency_name_en') is-invalid @enderror" type="text" name="currency_name_en" value="{{ old('currency_name_en', $nation->currency_name_en) }}" placeholder="العملة (الانجليزية)"/>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid @error('currency_code') is-invalid @enderror" type="text" name="currency_code" value="{{ old('currency_code', $nation->currency_code) }}" placeholder="كود العملة"/>
                                    @error('currency_code')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-3">
                                    <span class="switch switch-icon">
                                        <label>
                                            <input type="checkbox" @if($nation->status) checked="checked" @endif name="status"/>
                                            <span></span>
                                        </label>
                                    </span>
                                </div>
                            ...
                            <div class="my-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="image-input image-input-empty image-input-outline" id="kt_image_1" style="background-image: url({{ asset($nation->flag) }})">
