...
<div class="subheader py-2 py-lg-6  subheader-solid " id="kt_subheader">
   <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
      ...
      <div class="d-flex align-items-center">
        <a href="{{ route('packages.create') }}" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">إضافة باقة خصم</a>
      </div>
      <!--end::Toolbar-->
   </div>
</div>
...
<div class="card card-custom">
  <div class="card-header flex-wrap border-0 pt-6 pb-0">
    <div class="card-title">
      <h3 class="card-label">
        باقات الخصم
        <span class="d-block text-muted pt-2 font-size-sm">عرض جميع باقات الخصم</span>
      </h3>
    </div>
  </div>
  <div class="card-body">
      ...
      $(document).ready( function () {
       $('#dataTable').DataTable({
          ...
          columns: [
            ...
            { data: "factor_end_date", name: "factor_end_date", searchable: false},
