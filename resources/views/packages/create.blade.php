...
<div class="card card-custom">
    ...
    <div class="card-body px-0">
        <form class="form" id="kt_form" action="{{ route('packages.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-7 my-2">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid @error('name') is-invalid @enderror" type="text" name="name" value="{{ old('name') }}" placeholder="الكود"/>
                                    @error('name')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid @error('points') is-invalid @enderror" type="number" name="points" value="{{ old('points') }}" placeholder="النقاط"/>
                                    @error('points')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid @error('value') is-invalid @enderror" type="number" name="value" value="{{ old('value') }}" placeholder="القيمة"/>
                                    @error('value')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid @error('factor') is-invalid @enderror" type="number" name="factor" value="{{ old('factor') }}" placeholder="المعامل"/>
                                    @error('factor')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4 col-md-9 col-sm-12">
                                    <div class="input-group date" id="kt_datetimepicker_1" data-target-input="nearest">
                                        <input type="text" name="factor_end_date" class="form-control datetimepicker-input" placeholder="تاريخ النهاية" data-target="#kt_datetimepicker_1"/>
