...
@section('title', 'تعديل بيانات دعاية')
...
<div class="card card-custom">
    ...
    <div class="card-body px-0">
        <form class="form" id="kt_form" action="{{ route('advertisings.update', $advertising) }}" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-7 my-2">
                                ...
                                <div class="col-9">
                                    <select class="form-control form-control-solid @error('type_id') is-invalid @enderror" name="type_id">
                                        ...
                                        @foreach($advertisingTypes as $advertisingType)
                                            <option value="{{ $advertisingType->id }}" @if(old('type_id', $advertising->type_id) == $advertisingType->id) selected @endif>{{ $advertisingType->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('type_id')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid @error('goal') is-invalid @enderror" type="text" name="goal" value="{{ old('goal', $advertising->goal) }}" placeholder="الهدف من الدعاية"/>
                                    @error('goal')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid @error('start_date') is-invalid @enderror" type="date" name="start_date" value="{{ old('start_date', $advertising->start_date) }}"/>
                                    @error('start_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid @error('end_date') is-invalid @enderror" type="date" name="end_date" value="{{ old('end_date', $advertising->end_date) }}"/>
                                    @error('end_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid @error('advertiser') is-invalid @enderror" type="text" name="advertiser" value="{{ old('advertiser', $advertising->advertiser) }}" placeholder="القائم بالدعاية"/>
                                    @error('advertiser')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid @error('amount') is-invalid @enderror" type="number" name="amount" value="{{ old('amount', $advertising->amount) }}" placeholder="القيمة"/>
                                    @error('amount')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
